...
class BrowserUseClient:
    ...
    def __init__(self, api_key: str | None = None, proxy_country_code: str | None = None):
    ...
    def build_connect_url(self) -> BrowserUseSession:
        ...
        configured_country = (
            ...
            else getattr(_cfg, "BROWSER_USE_PROXY_COUNTRY_CODE", "")
        )
        proxy_country = str(configured_country or "").strip().lower()
