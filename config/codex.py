...
# ============================================================
# SMSBower 接码（SMS_PROVIDER="smsbower" 时使用；sms-activate 协议系）
# 客户端 API：https://smsbower.page/stubs/handler_api.php，鉴权用 ?api_key=
# ============================================================

# SMSBower 客户端 API 基址
SMSBOWER_API_BASE: str = "https://smsbower.page/stubs/handler_api.php"

# SMSBower API Key（在 smsbower.app 后台获取）
SMSBOWER_API_KEY: str = env_str("SMSBOWER_API_KEY", "")

# SMSBower 服务码：OpenAI (ChatGPT) = "dr"
SMSBOWER_SERVICE: str = "dr"

# 指定渠道号（providerIds，逗号分隔，如 "3170,4120"）。留空则平台自动选渠道。
# 渠道号可用 getPricesV3 按国家+服务查询各渠道 provider_id。
