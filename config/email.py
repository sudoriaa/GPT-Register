...
# ============================================================
# IMAP 邮箱模式（邮箱----密码直连取信，如 Roundcube 后端）
# EMAIL_SOURCE 含 "imap_pass" 时启用。导入格式：邮箱----密码
# ============================================================

# IMAP 服务器地址（Roundcube 后端示例：119.28.25.51）
IMAP_HOST = env_str("IMAP_HOST", "119.28.25.51")
...
#   1（fetch-token 模式）→ 走 OTP 登录拿已有账号的凭证（access_token/session_token）
WEBUI_ALLOW_LOGIN = env_bool("WEBUI_ALLOW_LOGIN", False)
